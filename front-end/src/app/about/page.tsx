    ...
    <div className="page-wrapper">
      ...
      <section className="page-header">
        <div
          ...
          style={{
            backgroundImage: "url(assets/images/backgrounds/page-header-img1.jpg)"
          }}
        ></div>
            ...
            <div className="col-xl-6">
              <div className="about-one__content">
                ...
                <div className="about-two__content-text1">
                  <p>
                    Alori is a full-service Florring company. Our established
                ...
                <div className="about-two__content-text2">
                  <p>
                    Dictum fusce ut placerat orci nulla. Amet aliquam cenas
                    ultricies. Facilisis sed odio morbi quis magnis{" "}
                  </p>
                </div>
            ...
            <div className="col-xl-6">
              <div className="mission-one__content">
                <div className="mission-one__content-single">
                  ...
                  <div className="text1">
                    <p>
                      There are more than 11 million young people in the uk, they
                      make up over a fifth of the population and represent
                      Britain’s future.
                    </p>
                  </div>
                  <div className="text2">
                    <p>
                      Tempor auf ullamcorper lacus vestibulum arcu. Posuere lorem
                      ipsum dolorsit consectetur adipiscing. Sollicitudin tempor
                      id eu nisl nunc ipsum. Odio tempor orci dapibus ultrices.
                      Quam viverra sagittis volutpat odio facilisis.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-xl-6">
              <div className="mission-one__img">
                <div className="shape1">
                  <img src="assets/images/shapes/mission-v1-shape1.jpg" alt="" />
                </div>
                <div className="mission-one__img-img1">
                  <img src="assets/images/resources/mission-v1-img1.jpg" alt="" />
                </div>
                <div
                  className="mission-one__img-img2 wow slideInRight"
      ...
      {/*Start Video One*/}
      <section
        className="video-one video-one--two video-one--two--about wow slideInUp"
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-12">
              ...
              >
                <div className="shape1">
                  <img src="assets/images/shapes/video-v1-shape1.png" alt="" />
                </div>
                <h2>
      ...
      <section className="team-one">
        <div className="container">
          <div className="sec-title text-center">
            <span className=" sec-title__tagline">Our Team</span>
            <h2 className="sec-title__title">Our talent Florring Team</h2>
          </div>
          <div className="row">
            ...
            >
              <div className="team-one__single">
                ...
                <div className="team-one__single-content text-center">
                  <h2>
                    <a href="team.html">Mahfuz Riad </a>
                  </h2>
                  <p>Wood Installer</p>
                </div>
              </div>
            ...
            >
              <div className="team-one__single">
                ...
                <div className="team-one__single-content text-center">
                  <h2>
                    <a href="team.html">Max Chaoma</a>
                  </h2>
                  <p>Floor Carpet Installer</p>
                </div>
              </div>
            </div>
            {/*End Single Team One*/}
            ...
            >
              <div className="team-one__single">
                ...
                <div className="team-one__single-content text-center">
                  <h2>
                    <a href="team.html">Foqrul Islam</a>
                  </h2>
                  <p>Wood Installer</p>
                </div>
              </div>
      ...
      {/*End Team One*/}
      {/*Start Contact One*/}
      <section className="contact-one contact-one--two">
        <div className="shape1">
      ...
      <footer className="footer-one footer-one--two">
        <div
          ...
          style={{
            backgroundImage: "url(assets/images/backgrounds/footer-v2-bg.jpg)"
          }}
        ></div>
                ...
                <div className="col-xl-12">
                  <div className="footer-one--two__contact-box-inner text-center">
                    <h2>
                      ...
                      <br /> or call us at{" "}
                      <a href="tel:123456789">81 282 11 101</a>
                    </h2>
